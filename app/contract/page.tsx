...
const LOADING_MESSAGES = [
  { delay: 0,     text: "מייצר את החוזה שלך...",             sub: "ה-AI כותב חוזה שלם, מותאם אישית — זה לוקח כ-3-5 דקות. אנחנו על זה 😊" },
  { delay: 20000, text: "עובדים על זה...",                   sub: "כל סעיף נבנה בשבילך בנפרד — סעיפי תשלום, לוחות זמנים, ביטול, קניין רוחני ועוד" },
  { delay: 60000, text: "עוד קצת...",                        sub: "חוזה מקצועי לוקח זמן להיכתב נכון — בדיוק כמו אצל עורך דין" },
  { delay: 120000, text: "כמעט שם...",                       sub: "עוד רגע החוזה מוכן ואנחנו שולחים אותו אוטומטית גם למייל שלך" },
  { delay: 180000, text: "עוד קצת סבלנות...",                sub: "אנחנו עדיין כאן — זה עובד, הכל בסדר 🙏 אל תרענן/י את הדף" },
  { delay: 240000, text: "כמעט סיימנו...",                   sub: "חוזים מורכבים לוקחים עד 5 דקות. תודה על הסבלנות!" },
];
