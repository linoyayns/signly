...
const LOADING_MESSAGES = [
  { delay: 0,     text: "מייצר את החוזה שלך...",             sub: "כן, אמרנו שזה ייקח כמה דקות — זה לא טעות 🙂" },
  { delay: 20000, text: "עובדים על זה...",                   sub: "כל סעיף נכתב בשבילך בנפרד — תשלום, לוחות זמנים, ביטול, קניין רוחני ועוד" },
  { delay: 60000, text: "עדיין כותבים...",                   sub: "חוזה אמיתי לא נכתב במהירות — גם אצל עורך דין זה לא קורה ב-10 שניות" },
  { delay: 120000, text: "כמעט שם...",                       sub: "עוד קצת ויש לך חוזה מוכן — נשלח אוטומטית גם למייל שלך" },
  { delay: 180000, text: "עדיין כאן 🙂",                      sub: "אל תרענן/י — אנחנו ממש לקראת הסוף" },
  { delay: 240000, text: "רגע אחרון...",                     sub: "חוזים מורכבים לוקחים עד 5 דקות. כמעט שם." },
];
