        ...
        <div className="reveal" style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div className="mob-testimonials" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 20 }}>
            [
              ...
              {
                stars: "★★★★★",
                text: "\"כבר קבעתי פגישה עם עורך דין לכתיבת חוזה והתבאסתי מהמחיר שהוא ביקש. קפצה לי מודעה של סיגנלי, אמרתי יאללה 97 שקל, מה כבר יכול להיות. הראיתי לחברה שלי שהיא עורכת דין, היא התעלפה מהתוצאה.\"",
