...
export default function HomePage() {
  return (
    <main className="min-h-screen flex flex-col" dir="rtl" style={{ fontFamily: "'Heebo', sans-serif", backgroundColor: "#FFFFFF", color: "#0F172A" }}>
        ...
        <div className="reveal" style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div className="mob-testimonials" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 20 }}>
            [
              {
                stars: "★★★★★",
                text: "\"בהתחלה הייתי סקפטי — מה פתאום AI יכתוב חוזה? אבל התוצאה שקיבלתי הייתה מקצועית ברצינות. שלחתי ללקוח ואפילו לא שאל שאלות. ואין עליו שום לוגו, אז אף אחד לא יודע שלא כתבתי אותו בעצמי.\"",
                author: "יובל מ. — צלם, חיפה",
              },
              {
                stars: "★★★★★",
                text: "\"הלקוח ניסה לטעון שלא סיכמנו על מספר התיקונים. פתחתי את החוזה — סעיף 4, שחור על גבי לבן. הוא שילם בלי להמשיך לדון. לא ידעתי שחוזה יכול לחסוך לי כאל כך שיחות.\"",
                author: "נועה כ. — מעצבת גרפית, תל אביב",
              },
              {
                stars: "★★★★★",
                text: "\"תמיד ידעתי שאני צריך חוזה אבל נרתעתי מהמחיר של עורך דין. לקח לי 4 דקות למלא את השאלון. החוזה שקיבלתי הכיל סעיפים שכלל לא חשבתי עליהם — כמו מה קורה אם הלקוח מכר את העסק.\"",
                author: "תומר ש. — מפתח פרילנס, תל אביב",
              },
              {
                stars: "★★★★★",
                text: "\"עורך דין ביקש ממני 900₪. אני בתחילת הדרך — זה לא ריאלי. שילמתי 97₪ וקיבלתי משהו שנראה בדיוק אותו דבר. הלקוח הראשון שלי חתם עליו בלי לשאול שום שאלה.\"",
                author: "מיכל ר. — מאמנת עסקית, באר שבע",
              },
        ...
        <div className="reveal" style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ background: "linear-gradient(135deg, rgba(83,58,253,0.06) 0%, rgba(124,58,237,0.08) 100%)", border: "1px solid rgba(83,58,253,0.15)", borderRadius: 20, padding: "48px 56px", textAlign: "center", marginBottom: 44 }}>
            ...
            <p style={{ fontSize: 16, color: "#64748B", lineHeight: 1.75, maxWidth: 660, margin: "0 auto 32px" }}>
              עברנו על מעל 50 חוזים שנכתבו על ידי עורכי דין ישראלים — כדי להבין אילו סעיפים חוזרים בכל חוזה מקצועי, אילו ניסוחים מגינים בפועל, ואיך גבולות מוגדרים בצורה ברורה ואכיפה.<br /><br />
      ...
      {/* PRICING */}
      <section id="pricing" style={{ padding: "80px 40px", background: "#FFFFFF" }}>
