      ...
      <section style={{ padding: "80px 40px", background: "#0F172A" }}>
        <div className="reveal" style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 16, color: "rgba(255,255,255,0.65)", lineHeight: 1.8, maxWidth: 620, margin: "0 auto 48px" }}>
            אימנו את ה-AI שלנו על מאות חוזי פרילנס ישראלים אמיתיים — עבדנו עם עורכי דין, ניתחנו מה עובד בבית משפט ומה נופל, ולימדנו אותו לחשוב כמו עורך דין שמכיר את השוק הישראלי. ChatGPT לא ראה את החוזים האלה. הוא לא יודע מה שומר עליך בדין הישראלי.
          </p>
          <div className="mob-col1" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, textAlign: "right" }}>
            {[
              ...
              { icon: "🧠", title: "למד מהאמיתיים", desc: "אומן על מאות חוזים שנכתבו על ידי עורכי דין ישראלים עבור פרילנסרים בתחומים שונים." },
