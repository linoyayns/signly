      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "100px 40px 80px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
          ...
          <section>
            ...
            <p style={{ fontSize: 15, color: "#374151", lineHeight: 1.85, marginBottom: 12 }}>
              התשלום מתבצע באמצעות Invoice4U — ספק עיבוד תשלומים ישראלי. Signly אינה שומרת פרטי כרטיס אשראי. עיבוד התשלום מתבצע ישירות על ידי Invoice4U, בכפוף לתנאי השירות ומדיניות הפרטיות שלה. החברה שומרת רישום של סכום העסקה, מועד ביצועה ואישור התשלום, לצרכי ביקורת ורישום חשבונאי.
            </p>
