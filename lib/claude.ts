...
יד. שלמות ההסכם — יד.1 ההסכם מהווה את מלוא ההסכמה בין הצדדים ומבטל כל הסכמה קודמת, מצג, התחייבות או הבטחה קודמים, בכתב או בעל-פה, ככל שהיו. יד.2 אם ייקבע כי הוראה כלשהי בהסכם זה בטלה, פסולה או בלתי אכיפה — יישארו יתר ההוראות בתוקפן המלא, וההוראה הפסולה תוחלף בהוראה תקפה הקרובה ביותר בתוכנה ובמטרתה להוראה שנפסלה.
...
**כללי ניסוח:**
- כתוב את כל 15 הסעיפים שפורטו לעיל (א עד טו), בסדר הזה, במלואם. אפשר להוסיף סעיפי משנה נוספים אם זה תורם לחוזה — אבל אסור לקצר, לדלג, או להשמיט חלק מהתוכן שצוין.
- חשוב מאוד: סעיף טו (חתימות) חייב להופיע במלואו בסוף החוזה — הוא קריטי ולא ניתן להשמיט אותו. אם יש צורך לקצר ניסוח כדי שהחוזה כולו יכלל בתשובה — קצר את הניסוח בסעיפים א-יג, אך לעולם אל תקצר או תשמיט את סעיף טו.
